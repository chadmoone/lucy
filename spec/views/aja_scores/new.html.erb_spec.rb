...
describe "aja_scores/new" do
  before(:each) do
    assign(:aja_score, stub_model(AjaScore,
      :diamond => nil,
  ...
  it "renders new aja_score form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => aja_scores_path, :method => "post" do
