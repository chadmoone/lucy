...
page = Nokogiri::HTML(open("http://www.bluenile.com/diamond-details-panel?pid=LD02718595"))

price = page.css('div.details_column')[1].css('td')[3].text.gsub(/[\D]/, '').to_f
available = page.css('div.shipping p').text != "Not Available For Purchase."

puts "Price: #{price} - Available: #{available}"